...
void get_usb_serial(char *usb_serial_number)
{
	...
	sprintf(temp_serial_number,"i579%09x",unique_serial_number);
#elif defined(CONFIG_MACH_TOTORO_CTC)
	sprintf(temp_serial_number,"i509%09x",unique_serial_number);
#elif defined(CONFIG_MACH_TASS_CTC)
	sprintf(temp_serial_number,"i559%09x",unique_serial_number);
