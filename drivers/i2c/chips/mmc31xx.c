...
static DEVICE_ATTR(read_mag, 0664, mmc31xx_fs_read, mmc31xx_fs_write);
static DEVICE_ATTR(power_on, 0664, mmc31xx_power_on, NULL);
...
#if defined(CONFIG_MACH_COOPER) && !defined(CONFIG_MACH_COOPER_CTC)
