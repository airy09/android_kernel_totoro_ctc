...
#define GPIO_SENSE_OUT	18//124 twkim add proximity sensor driver to totoro_ctc
#else
#define GPIO_SENSE_OUT	124
#endif

#define SENSOR_MODE_B1 1
#define SENSOR_MODE_B15 2
#define SENSOR_MODE_B2 3

#define SENSOR_MODE SENSOR_MODE_B15
...
#define INT_CLEAR    0 /* 0 = by polling operation, 1 = by interrupt operation */
