...
#if !defined(CONFIG_MACH_TASS_CTC) && !defined(CONFIG_MACH_COOPER_CTC)        // odam request
...
#if defined(CONFIG_MACH_COOPER_CTC) || defined(CONFIG_MACH_TASS_CTC)	  // odam request
