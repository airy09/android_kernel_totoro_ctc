...
static unsigned int keypad_row_gpios[] = { 33, 34, 35 }; /* scan */
static unsigned int keypad_col_gpios[] = { 42, 41, 40, 39 }; /* sense */
...
//	.name		= "surf_keypad",
	...
	.name		= "lucas_keypad0",			
#elif defined(CONFIG_MACH_EUROPA) || defined(CONFIG_MACH_TASS_CTC)
	.name		= "europa_keypad0",
#endif
