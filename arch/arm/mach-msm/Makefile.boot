...
ifeq ($(CONFIG_MACH_COOPER_CTC),y)
   zreladdr-$(CONFIG_ARCH_MSM7X27)	:= 0x13008000#0x00408000
params_phys-$(CONFIG_ARCH_MSM7X27)	:= 0x13000100#0x00400100
initrd_phys-$(CONFIG_ARCH_MSM7X27)	:= 0x14000000#0x0A000000
else
   zreladdr-$(CONFIG_ARCH_MSM7X27)	:= 0x13608000
params_phys-$(CONFIG_ARCH_MSM7X27)	:= 0x13600100
initrd_phys-$(CONFIG_ARCH_MSM7X27)	:= 0x14600000
